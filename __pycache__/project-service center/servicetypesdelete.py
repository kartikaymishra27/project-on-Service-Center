...
def showservicetypesdelete():
    t=tkinter.Tk()
    t.geometry('600x400')
    t.title('Service-types delete')
    def cx():
        t.destroy()
    ...
    z=Label(t,text='Delete from Service Types',font=('arial',20,'bold','underline'),bg='white')
    z.place(x=140,y=50)    
    ...
    #find
    btn1=Button(t,text='Delete',font=('arial',18),bg='lightgray',fg='black',command=delete)
    btn1.place(x=100,y=290)
    
     #Close
    btn2=Button(t,text='Back',font=('arial',20),bg='lightgray',fg='black',command=cx)
    btn2.place(x=350,y=290)
    t.mainloop()