...
def showservicetypesdelete():
    ...
    z=Label(t,text='Delete from Service Types',font=("Segoe UI", 24, "bold"), fg="#0A3D62", bg="white", relief="raised")
    z.place(x=100,y=50)    
    
    a=Label(t,text='Service ID :',font=('arial',20))
    a.place(x=100,y=150)
