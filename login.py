...
btn = tk.Button(t, text="Login", bg="#0f4c75", fg="white",
                font=("Segoe UI", 15, "bold"), relief="raised", padx=10, pady=5,
                cursor="hand2", command=check)
btn.place(x=525, y=380)
show_pass = tk.IntVar()
signup_btn = tk.Button(t, text="Sign Up", 
                      font=("Segoe UI", 15,'bold'),  bg="#0f4c75", fg="white", relief="raised",padx=10, pady=5,
                      cursor="hand2")
signup_btn.place(x=675, y=380)

forgot_btn = tk.Button(t, text="Forgot Password?", width='20',
                       font=("Segoe UI", 12, "underline",'bold'), bg="#0f4c75", fg="white", relief="raised"
                       ,command=send_otp_window)
forgot_btn.place(x=550, y=460)
...
def on_enter(e): forgot_btn['bg'] = '#3282b8'
def on_leave(e): forgot_btn['bg'] = '#0f4c75'
